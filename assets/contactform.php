...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Interested in Airstream For Sale";
...
//These are the items that populate the email
    $error_message = "";
  ...
  if(strlen($city_state) < 2) {
    $error_message .= 'The city and state you entered does not appear to be valid.<br />';
  }
